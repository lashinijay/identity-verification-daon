...
package org.wso2.carbon.identity.verification.daon.api.dispatcher;

import org.apache.commons.lang3.StringUtils;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.wso2.carbon.identity.verification.daon.api.common.error.ErrorDTO;
...
/**
 * Maps input validation exceptions to HTTP 400 responses.
 */
public class InputValidationExceptionMapper implements ExceptionMapper<ConstraintViolationException> {
    ...
    private static final String ERROR_CODE = "DIDV-60000";
    private static final String ERROR_MESSAGE = "Invalid Request";
    private static final String ERROR_DESCRIPTION = "Provided request content is not in the expected format";
